...
class CreateContactListAccounts < ActiveRecord::Migration[7.2]
  def change
    create_table :contact_list_accounts do |t|
    ...
    add_index :contact_list_accounts, [:contact_list_id, :account_id], unique: true
  end
end
